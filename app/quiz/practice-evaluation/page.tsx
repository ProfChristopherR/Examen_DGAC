...
import { ClipboardCheck, ChevronLeft, ChevronRight, Check, X, ArrowLeft, Send, Trophy, AlertCircle, Mail, Loader2, FlaskConical } from 'lucide-react'
...
export default function PracticeEvaluationQuiz() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Save to Supabase as practice-evaluation (no email sent)
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 mb-8">
              <span className="inline-flex items-center gap-2 text-sm text-cyan-300">
                <FlaskConical className="w-4 h-4" strokeWidth={1.5} /> Modo Ensayo — Resultados guardados localmente
              </span>
            </div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <div className="mb-4 p-3 rounded-xl bg-cyan-500/10 border border-cyan-500/20 text-center">
          <p className="text-sm text-cyan-300">
            Modo Ensayo — Practica con 60 preguntas aleatorias. Los resultados no se envían por correo.
          </p>
        </div>
